...
public class MusicOrganizer
{
    ...
    {
        if(reproduccion){
            System.out.println("Error: Se esta reproduciendo una cancion");
        }
        else{
            if(indexValid(index)) {
                ...
                //asi se indica que se reproduce la cancion
                reproduccion = true;
    ...
    public void isPlaying()
    {
        ...
        if(reproduccion){
            ...
            System.out.println("No hay ninguna reproducción");
        }
    ...
    public void listAllTrackWithIterator()
    {
        ...
        while(iterador.hasNext()){
            Track detallesTracks = iterador.next();
            System.out.println(detallesTracks.getDetails());
        }
    }
    
    public void removeByArtist(String artistaABuscar)
    {
        Iterator<Track> iterador = tracks.iterator();
        while(iterador.hasNext()){
            Track pistasMusica = iterador.next();
            String artista = pistasMusica.getArtist();
            if(artista.equals(artistaABuscar)){
                iterador.remove();
            }
        }
    }
